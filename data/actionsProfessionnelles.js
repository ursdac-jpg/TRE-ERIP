...
var CATALOGUE_ACTIONS_PRO = [
  {
    ...
    items: [
      ...
      { id: 'planifier', label: 'Planifier', icon: '📅', categorie: 'Organisation / Gestion',
        ...
        savoirs: [], metiers: ['Chef d\'equipe', 'Assistant administratif'] },
      { id: 'gerer', label: 'Gerer', icon: '📊', categorie: 'Organisation / Gestion',
        savoirFaire: ['Gestion administrative', 'Gestion de projet'], savoirEtre: ['Organisation', 'Responsabilite'],
        savoirs: [], metiers: ['Comptable / Assistant comptable', 'Chef d\'equipe'] },
      { id: 'controler', label: 'Controler', icon: '🔍', categorie: 'Organisation / Gestion',
        savoirFaire: ['Diagnostic', 'Analyse de donnees'], savoirEtre: ['Rigueur'],
      ...
      { id: 'analyser', label: 'Analyser', icon: '📈', categorie: 'Organisation / Gestion',
        savoirFaire: ['Analyse de donnees', 'Raisonnement logique', 'Redaction'], savoirEtre: ['Rigueur'],
        savoirs: [], metiers: ['Comptable / Assistant comptable', 'Developpeur informatique'] },
      { id: 'negocier', label: 'Negocier', icon: '🤝', categorie: 'Organisation / Gestion',
        savoirFaire: ['Negociation', 'Persuasion'], savoirEtre: ['Communication'],
  ...
  },
  {
    ...
    items: [
      { id: 'conseiller', label: 'Conseiller', icon: '💬', categorie: 'Relationnel',
        savoirFaire: ['Conseil'], savoirEtre: ['Communication', 'Pedagogie'],
        savoirs: [], metiers: ['Conseiller de vente', 'Agent d\'accueil'] },
      { id: 'accompagner', label: 'Accompagner', icon: '🤝', categorie: 'Relationnel',
        savoirFaire: ['Soins'], savoirEtre: ['Empathie', 'Aide a la personne', 'Patience'],
      ...
      { id: 'aider', label: 'Aider', icon: '🤲', categorie: 'Relationnel',
        savoirFaire: [], savoirEtre: ['Empathie', 'Aide a la personne', 'Entraide'],
        savoirs: [], metiers: ['Assistant de vie aux familles (ADVF)', 'Accompagnant educatif et social (AES)'] },
      { id: 'informer', label: 'Informer', icon: '📢', categorie: 'Relationnel',
        savoirFaire: ['Redaction'], savoirEtre: ['Communication', 'Sens du service'],
  ...
  },
  {
    ...
    icone: '🔧',
    items: [
      { id: 'reparer', label: 'Reparer', icon: '🔧', categorie: 'Technique',
        savoirFaire: ['Diagnostic', 'Reparation', 'Maintenance'], savoirEtre: [],
        savoirs: [], metiers: ['Technicien de maintenance', 'Mecanicien automobile'] },
      { id: 'transporter', label: 'Transporter', icon: '🚚', categorie: 'Technique',
        savoirFaire: ['Logistique', 'Conduite'], savoirEtre: ['Respect des delais'],
        savoirs: ['Reglementation du transport routier'], metiers: ['Chauffeur-livreur', 'Cariste'] },
      { id: 'nettoyer', label: 'Nettoyer', icon: '🧹', categorie: 'Technique',
        savoirFaire: ['Hygiene', 'Entretien'], savoirEtre: ['Rigueur'],
      ...
      { id: 'construire', label: 'Construire', icon: '🏗', categorie: 'Technique',
        savoirFaire: ['Batiment', 'Lecture de plans', 'Travail manuel'], savoirEtre: [],
        savoirs: ['Normes de securite sur chantier'], metiers: ['Macon', 'Manoeuvre / Aide de chantier'] },
      { id: 'fabriquer', label: 'Fabriquer', icon: '⚙️', categorie: 'Technique',
        savoirFaire: ['Travail manuel', 'Technique', 'Precision'], savoirEtre: ['Rigueur'],
        savoirs: [], metiers: ['Soudeur', 'Operateur d\'usinage (commande numerique)'] },
      { id: 'installer', label: 'Installer', icon: '🔌', categorie: 'Technique',
        savoirFaire: ['Technique', 'Reparation'], savoirEtre: ['Securite'],
      ...
      { id: 'decouper', label: 'Decouper', icon: '✂️', categorie: 'Technique',
        savoirFaire: ['Travail manuel', 'Precision'], savoirEtre: ['Securite'],
        savoirs: [], metiers: ['Boucher', 'Operateur en transformation des viandes / conserverie'] },
      { id: 'preparer_commandes', label: 'Preparer des commandes', icon: '📦', categorie: 'Technique',
      ...
      { id: 'conduire', label: 'Conduire / Piloter', icon: '🚜', categorie: 'Technique',
        savoirFaire: ['Conduite'], savoirEtre: ['Securite', 'Autonomie'],
  ...
  },
  {
    ...
    icone: '🎨',
    items: [
      { id: 'creer', label: 'Creer', icon: '🎨', categorie: 'Creation',
        savoirFaire: ['Innovation', 'Expression artistique'], savoirEtre: ['Creativite'],
        savoirs: [], metiers: [] },
      { id: 'rediger', label: 'Rediger', icon: '✍️', categorie: 'Creation',
        savoirFaire: ['Redaction'], savoirEtre: ['Creativite'],
        savoirs: [], metiers: [] },
      { id: 'imaginer', label: 'Imaginer', icon: '💡', categorie: 'Creation',
        savoirFaire: ['Innovation'], savoirEtre: ['Creativite'],
        savoirs: [], metiers: [] },
      { id: 'photographier', label: 'Photographier', icon: '📷', categorie: 'Creation',
        savoirFaire: ['Expression artistique'], savoirEtre: ['Creativite'],
        savoirs: [], metiers: [] },
      { id: 'dessiner', label: 'Dessiner', icon: '✏️', categorie: 'Creation',
        savoirFaire: ['Expression artistique'], savoirEtre: ['Creativite'],
        savoirs: [], metiers: [] }
    ]
  },
  {
    ...
    items: [
      { id: 'cuisiner', label: 'Cuisiner', icon: '🍳', categorie: 'Cuisine',
        savoirFaire: ['Cuisine'], savoirEtre: ['Creativite', 'Respect des normes'],
        savoirs: ['Regles d\'hygiene alimentaire (HACCP)'],
  ...
  },
  {
    ...
    items: [
      { id: 'calculer', label: 'Calculer', icon: '🧮', categorie: 'Administration',
        savoirFaire: ['Gestion financiere'], savoirEtre: ['Rigueur'],
        savoirs: ['Bases de comptabilite'], metiers: ['Comptable / Assistant comptable'] },
      ...
      { id: 'communiquer_ecrit', label: 'Communiquer par ecrit', icon: '📧', categorie: 'Administration',
        savoirFaire: ['Redaction', 'Bureautique'], savoirEtre: ['Communication'],
        savoirs: [], metiers: ['Assistant administratif', 'Secretaire medicale'] },
